...
$app->get('/process/:keyword/:date1/:date2', function ($keyword, $date1,$date2) use ($app) {
    ...
    $tweets = $twitter->requestTweet('search/tweets', array('q' => "$keyword  -http -filter:retweets -filter:links -filter:replies -filter:images since:$date1 until:$date2 lang:en", 'request_type'=> 'recent','count' => 20, 'exclude_replies' => true));
